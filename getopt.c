...
#if !defined(_STDLIB_H_) || !defined(getenv)
char *getenv(const char *);
#endif /* !_STDLIB_H_ || !getenv */
...
#  endif
	...
	/**
	 **  Skip the remaining characters of the long option up to the end of
	 **  its name (End of the option itself or the '=' sign)
	 **/
