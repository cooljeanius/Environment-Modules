...
Big changes for 2.0:
   ...
   So, if you to a '`puts stdout`' in any of your modulefiles, that will go directly to the shell.
...
------------------------------------------------------------------------
   ...
   Enable this feature for debugging only!
...
------------------------------------------------------------------------
   ...
   - Turns tracing for the specific module command on or off.
